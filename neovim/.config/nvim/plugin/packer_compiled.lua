...
_G.packer_plugins = {
  ...
  ["github-nvim-theme"] = {
    ...
    loaded = true,
    path = "/Users/wolf/.local/share/nvim/site/pack/packer/start/github-nvim-theme",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'null-ls.nvim', 'nvim-treesitter-textobjects', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
