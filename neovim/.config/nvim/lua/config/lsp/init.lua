...
local servers = {
  ...
  terraformls = {
    ...
    root_dir = function(fname)
      -- prioritize a git repo, otherwise fallback to .terraform
      return util.root_pattern(".git")(fname) or util.root_pattern(".terraform")(fname)
    end,
  },
  tflint = {},
  tsserver = {},
...
function M.on_attach(client, bufnr)
  ...
  -- 	vim.lsp.with(vim.lsp.diagnostic.on_publish_diagnostic, { virtual_text = true })
