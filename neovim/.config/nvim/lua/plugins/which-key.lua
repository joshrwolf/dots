...
wk.register({
    ["<space>"] = { tele.find_files, "Find file" },
    -- Find
    f = {
        name = "+find",
        f = { tele.find_files, "Find file" },
        d = { tele.grep_string, "Grep string" },
    ...
    o = {
      ...
      g = { "<cmd>Neotree git_status<CR>", "Toggle git status"},
      t = { "<cmd>ToggleTerm direction=horizontal<CR>", "Toggle attached terminal" },
